{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.06.03.09.49.preview.03";
      versionPath = "0.2026.06.03.09.49.preview_03";
      hashes = {
        amd64 = "sha256-GF9jP21wRknoSMK0ARxS6LQjH4APOCgegKstX65CC8Y=";
        arm64 = "sha256-l/0k62XzXzEE0zhE2gLGnvBZcE/h2sJX0yvZC6BBa2o=";
      };
