{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.04.15.08.45.preview.02";
      versionPath = "0.2026.04.15.08.45.preview_02";
      hashes = {
        amd64 = "sha256-NNFXI87E5kONnWc3jGdgxuQ0hr2MpSYdPWOsMv3c8F0=";
        arm64 = "sha256-xEzY0ARW0m6EIXVONzPsI0BXhpMPR7twCZ+YACqqu2A=";
      };
