{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.20.09.21.preview.03";
      versionPath = "0.2026.05.20.09.21.preview_03";
      hashes = {
        amd64 = "sha256-YeLE6y969CukV3XiqPSmBzYPfZVLxmDPa0zqr5mxTD4=";
        arm64 = "sha256-+rybTm7U0WPwslDI+U0dOXl1jfEFgsHtnuUurYE6ReM=";
      };
