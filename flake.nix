{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.08.17.54.preview.02";
      versionPath = "0.2026.07.08.17.54.preview_02";
      hashes = {
        amd64 = "sha256-L7naQ7JoNeL33mIPrusqIDZ1MpAaa/CHOaD7YB/zWEg=";
        arm64 = "sha256-dp6tf3PHnEoz+LJRij+jNo2EN2fIK5Z1+mqMO60dp6U=";
      };
