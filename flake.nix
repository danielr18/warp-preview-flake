{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.06.03.09.49.preview.04";
      versionPath = "0.2026.06.03.09.49.preview_04";
      hashes = {
        amd64 = "sha256-CI1oIAYCEh1qBnNDZ+REyqC62Q2nVCoFrsNuezgadBE=";
        arm64 = "sha256-dI518mR+sFU5tEIqq/dhn1a6urXWPYvq590Q0wr5yvU=";
      };
