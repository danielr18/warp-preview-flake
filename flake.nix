{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.09.02.08.27.preview.01";
      versionPath = "0.2026.09.02.08.27.preview_01";
      hashes = {
        amd64 = "sha256-yye+LCN7aoF5/vQUsA92hU9qh2BIiTkiQt1Hz6fVC4I=";
        arm64 = "sha256-Hsg40BATS7G3E4RbRT0VHRD8LQtGJnfoaErK7/Jd0dE=";
      };
