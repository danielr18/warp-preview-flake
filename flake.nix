{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.06.15.42.preview.05";
      versionPath = "0.2026.05.06.15.42.preview_05";
      hashes = {
        amd64 = "sha256-X2V8M2cmUSB9ZuQvYw67C4OjV9NaLCnBeWRxCeZ+gPo=";
        arm64 = "sha256-KwSXD+z7FciZ/w8ruRpkbfSxqJ3+SqqUHXopROOOvGc=";
      };
