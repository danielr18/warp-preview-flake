{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.06.15.42.preview.04";
      versionPath = "0.2026.05.06.15.42.preview_04";
      hashes = {
        amd64 = "sha256-jaRUgmG2mL/rzyBN2Kib0+C5TdIpnQPT5YIoKE/1VVQ=";
        arm64 = "sha256-/qOk+LYKtv70KKzx4fwCeD+CIyNMlSkp/vWICsKwAec=";
      };
