{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.06.24.09.19.preview.03";
      versionPath = "0.2026.06.24.09.19.preview_03";
      hashes = {
        amd64 = "sha256-AkXovP9prYT9bhGxQ46MKsr748CeVaH/lUcJSbpraOw=";
        arm64 = "sha256-INuCDStY3kgmk6YPrVJUNv0X9DWJE7zMtDDMDbA6o2M=";
      };
