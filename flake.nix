{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.04.29.08.57.preview.01";
      versionPath = "0.2026.04.29.08.57.preview_01";
      hashes = {
        amd64 = "sha256-/cl4ecA6uJ8GtmWfSJbF80giZoFmVQvyjpR6I5bt07A=";
        arm64 = "sha256-wUWyjgBtXaPmUP8/lLp6d/3Bs+EN/PlKN4g2Zk+NbWs=";
      };
