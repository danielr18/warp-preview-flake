{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.06.03.09.49.preview.01";
      versionPath = "0.2026.06.03.09.49.preview_01";
      hashes = {
        amd64 = "sha256-pbQK5FM8QAG8pa/W2RFV9iFbcVt5CoXzYzCofSMevOM=";
        arm64 = "sha256-RYA3M30sOsSG2az3S9Q/UNizUp5a/0oB/1zeIzkzHcw=";
      };
