{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.22.09.01.preview.01";
      versionPath = "0.2026.07.22.09.01.preview_01";
      hashes = {
        amd64 = "sha256-8jMcwaS5YGZ1MqbQx6FOaU9BUN5uD5ycKyKpxMmT2hc=";
        arm64 = "sha256-p5Ja7JLXX7su4cHC2W0WNm83I4C32FYp8TNOh+PbEW0=";
      };
