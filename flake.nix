{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.08.26.17.59.preview.01";
      versionPath = "0.2026.08.26.17.59.preview_01";
      hashes = {
        amd64 = "sha256-lvI9uvF71qWnkfhy/6ydZK2t1zvLQgkRUUoAHzVSHA0=";
        arm64 = "sha256-azg03/zZYDQnBGQF9U42cQs4VQkN571gGl6L4MJIFWk=";
      };
