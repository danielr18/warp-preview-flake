{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.18.05.32.preview.02";
      versionPath = "0.2026.05.18.05.32.preview_02";
      hashes = {
        amd64 = "sha256-DK9CAZfsaOMECQ2ho7H6W0p0yrgs+NFmm6e7ZQ+8c7U=";
        arm64 = "sha256-qNmYUpvDfgxMuebkZy0JJv7Sl6GcKCb2fC10Vn3GV5w=";
      };
