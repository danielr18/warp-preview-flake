{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.14.19.38.preview.03";
      versionPath = "0.2026.05.14.19.38.preview_03";
      hashes = {
        amd64 = "sha256-aQRP9tnsnP0Ko3h39j5pDMgPkDRiUy1UPDWjWCgAzuE=";
        arm64 = "sha256-JuHkuCGSmRq6mqOGlFz2G+esKEKbjXI+VpZg21yveZA=";
      };
