{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.18.05.32.preview.03";
      versionPath = "0.2026.05.18.05.32.preview_03";
      hashes = {
        amd64 = "sha256-ZthOjkz0JuTB7Z+qJrUdAPXW+roohUHalae0oWUSDBw=";
        arm64 = "sha256-iJooTu2wIBB7O9w03z9tNmK+Us4udFiG4MrFCI43agY=";
      };
