{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.06.15.42.preview.03";
      versionPath = "0.2026.05.06.15.42.preview_03";
      hashes = {
        amd64 = "sha256-0eIqhl94CY9g7/ns90zYBcToeZ9cr4p1mP4CHleDVyc=";
        arm64 = "sha256-rIYhkfg4pQIgpakbDTSAIgz+xjM+X1oVt3Gj+SYeOww=";
      };
