{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.08.17.54.preview.01";
      versionPath = "0.2026.07.08.17.54.preview_01";
      hashes = {
        amd64 = "sha256-6039+qFgtg+lBxunO4TqQPMYmwjfGgFabS9COyO/N1o=";
        arm64 = "sha256-1QnKPU19/+7vE6BZzRKNxgBLYtlNdDpCaTGNk0460cA=";
      };
