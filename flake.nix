{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.20.09.21.preview.04";
      versionPath = "0.2026.05.20.09.21.preview_04";
      hashes = {
        amd64 = "sha256-cwuhZiEKyGCHko9J3JzDyGwkjKeq+e4u+CmoqTaiOjU=";
        arm64 = "sha256-r899R1kYoi7v5mDUYwNzJYpNMScDBU3Jw+eQbmYx3rQ=";
      };
