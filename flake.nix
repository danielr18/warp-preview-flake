{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.05.27.15.44.preview.01";
      versionPath = "0.2026.05.27.15.44.preview_01";
      hashes = {
        amd64 = "sha256-xa7njtpP61BJJ9WkhS+u/LijSSJm3+3s0Fe8NT4TUL8=";
        arm64 = "sha256-OJwMbiGPeFaRwuG7GG5YqkwlhEaYhcVpdZDRLWVzS/w=";
      };
