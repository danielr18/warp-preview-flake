{
  ...
  outputs =
    ...
    let
      ...
      versionPath = "0.2026.08.19.08.15.preview_01";
      hashes = {
        amd64 = "sha256-l1M9JPHfhN+/DpT16jVhHdaE4CvVz5uvjhSJHqRJ8tk=";
        arm64 = "sha256-MlTsKkYk0sy69icrdW0nNM7iqTx5umjzVYgixAwti0A=";
      };
