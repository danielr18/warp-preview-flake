{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.29.09.05.preview.02";
      versionPath = "0.2026.07.29.09.05.preview_02";
      hashes = {
        amd64 = "sha256-nxnNgSyXreG/slB1/MWeCg1APq222HqbkhThrjqd+K0=";
        arm64 = "sha256-6Q24YU984JZnq+wNUx5cNv3BGt4I6p1M816FQaARFmc=";
      };
