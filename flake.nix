{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.15.08.55.preview.01";
      versionPath = "0.2026.07.15.08.55.preview_01";
      hashes = {
        amd64 = "sha256-jtrFTXiJ50aELxCoRNKOFQgfDNYuWdUYG72ikCWTpu8=";
        arm64 = "sha256-HGKhC7Eqrz4G+Arqmi318hlt5EuL19O2xDn2heZkK1E=";
      };
