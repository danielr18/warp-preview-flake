{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.09.09.08.26.preview.02";
      versionPath = "0.2026.09.09.08.26.preview_02";
      hashes = {
        amd64 = "sha256-hH3my3Ies6Ok6PTh/8IhtFcQW9vZRnm7h74q15K8BJA=";
        arm64 = "sha256-LfGI3AEnMG5vDjAL6KQQ5LvntXRuyfa0TYsqx5Ec+To=";
      };
