{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.06.03.09.49.preview.02";
      versionPath = "0.2026.06.03.09.49.preview_02";
      hashes = {
        amd64 = "sha256-TI41KmIGaRJRMY4sW4bNhFsx+pN3Ei89srDS4rMiKzI=";
        arm64 = "sha256-97WaJhqS5dWsgCCRnM4zN4AqfB535ATZMm+mlSXiEY8=";
      };
