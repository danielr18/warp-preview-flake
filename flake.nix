{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.04.27.15.33.preview.02";
      versionPath = "0.2026.04.27.15.33.preview_02";
      hashes = {
        amd64 = "sha256-ISKEqDN+T3WA1Q4eHHA3bC+PQAinNTrgEDrVhpPD3CA=";
        arm64 = "sha256-MoC1F+RLsyahJhCtRpV8dJVxGR4CiogGsD0cnqjR5sU=";
      };
