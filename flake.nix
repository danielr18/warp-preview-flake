{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.07.01.09.21.preview.01";
      versionPath = "0.2026.07.01.09.21.preview_01";
      hashes = {
        amd64 = "sha256-RsHrFZlg65DpQdaHrtEOXL8GHDHEQcebh3aBoMo+Z7I=";
        arm64 = "sha256-vL3yDjgDJ0xaEpL5N1V3ltJWetUeO+iwCKCwXSr8M/s=";
      };
