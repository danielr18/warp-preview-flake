{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.04.21.20.43.preview.02";
      versionPath = "0.2026.04.21.20.43.preview_02";
      hashes = {
        amd64 = "sha256-VG+XxDgkTQ93KNqPLT4BzzxsHiKwDTT0nAW3QdVRwZg=";
        arm64 = "sha256-Gd88NglnRTyTeW5q2pCic6iurNa4EAp1wYG6O44X78Q=";
      };
