{
  ...
  outputs =
    ...
    let
      ...
      versionPath = "0.2026.08.18.02.52.preview_00";
      hashes = {
        amd64 = "sha256-ffgu4MMc3Ej9FNPK+63iRDFo5q0Gwf3vQYBrF7VHMqE=";
        arm64 = "sha256-nDghQoZMkEsTOtbuMoZREY2wlMxdbn58MUn0f2o/kIc=";
      };
