{
  ...
  outputs =
    ...
    let
      ...
      version = "0.2026.04.23.19.42.preview.03";
      versionPath = "0.2026.04.23.19.42.preview_03";
      hashes = {
        amd64 = "sha256-vpwnLNCPV1Fw+3ItwHITqIyOPUZMjbBOyHfv5dsBnEw=";
        arm64 = "sha256-7vxnzimn/VbRH6I4ZOz+7qkKHAUfvo40sGOIBMb3mTs=";
      };
